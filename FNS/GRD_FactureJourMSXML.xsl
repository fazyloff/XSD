...
<xsl:stylesheet version="1.0" xmlns:msxsl="http://exslt.org/common" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                xmlns:n="http://schemas.microsoft.com/dynamics/2008/01/documents/FactureJour_GRD" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="n xs xsi xsl">
						...
						<xsl:for-each select="n:FactureTrans_RU">
							<СведТов>
								...
								<xsl:for-each select="n:GRD_LineInfo">
									...
									<xsl:for-each select="msxsl:node-set($lines)/match">
										...
										<xsl:for-each select="msxsl:node-set($cells)/match">
											<ИнфПолСтр>
